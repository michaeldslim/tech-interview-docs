document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadDocument() {
        const filePath = currentLanguage === 'ko' 
            ? `react_interview_ko_${currentPart}.md` 
            : `en/react_interview_en_${currentPart}.md`;
    ...
    function extractQuestions(markdown) {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            // The React markdown format has the question number at the beginning of the line
    ...
    function updateDocumentTitle() {
        ...
        documentTitle.textContent = `React Interview Questions - ${partText} (${languageText})`;
    }
